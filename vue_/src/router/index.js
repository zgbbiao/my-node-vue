...
export const asyncRouterMap = [
 {
    path: '/',
    redirect: '/books/catalogue',
    name: '首页',
    component: Full,
    hidden: true,
    meta: { jurisdiction: ['admin', 'teacher-normal'] },
    children: [
     { path: '/merber', name: '会员', icon: 'person-stalker', redirect: '/merber/list',
        component: { render (c) { return c('router-view') } }, meta: { jurisdiction: ['admin', 'teacher-normal'] }, 
        children: [
          { path: 'list', name: '会员列表', icon: 'person', component: _import('system/merber/list'), meta: { jurisdiction: ['admin'] } },
          { path: 'details', name: '会员详情', hidden: true, icon: 'ios-compose', component: _import('system/merber/details'), meta: { jurisdiction: ['admin', 'teacher-normal'] } }
        ]
      },
      {
        path: '/books', name: '书籍', icon: 'ios-book-outline', reject: '/books/catalogue',
        component: { render (c) { return c('router-view') } }, meta: { jurisdiction: ['admin', 'teacher-normal'] },
        children: [
          { path: 'add', name: '添加书籍', hidden: false, icon: 'person', component: _import('system/books/add'), meta: { jurisdiction: ['admin'] } },
          { path: 'catalogue', name: '查看书籍', hidden: false, icon: 'ios-compose', component: _import('system/books/catalogue'), meta: { jurisdiction: ['admin', 'teacher-normal'] } },
          { path: 'details', name: '书籍详情', hidden: true, icon: 'ios-compose', component: _import('system/books/details'), meta: { jurisdiction: ['admin', 'teacher-normal'] } }
        ] 
      }
    ]
    //  { path: '/dashboard', name: 'Dashboard', icon: 'speedometer', component: _import('Dashboard'), meta: { jurisdiction: ['admin', 'teacher-normal'] } },
    ...
    //   {path: '/tinymce',name: 'Tinymce编辑器',icon:"android-document",component: _import('Tinymce')},
      // {path: '/wz',name: 'Wz',icon:"android-list",component: _import('wz')},
      // { path: '/markdown', name: 'Markdown', icon:'android-list', component: _import('Markdown'), meta: { jurisdiction: ['admin', 'teacher-normal'] } },
  }
];
